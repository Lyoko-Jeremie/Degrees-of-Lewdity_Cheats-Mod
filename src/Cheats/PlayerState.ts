...
export class PlayerState {
    ...
    init() {
        ...
        [
            ...
            new PSI('milk_amount', '乳量', 10000, 0, this.thisW),
            new PSI('milk_volume', '母乳容量', 10000, 0, this.thisW),
            new ItemPlaceHolder(),
            // sexStats.pills
            ...
            new PSI('semen_amount', '精液量', 10000, 0, this.thisW),
            new PSI('semen_volume', '精液容量', 10000, 0, this.thisW),
            new ItemPlaceHolder(),
